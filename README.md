...
# Multithread
The multithread it's a complex (To me for now) thing, that you can make process happen in parallen, and that's really code and optimal, i want to add to it. But becasue it's a really difficult, and i will not implement it for now.
