...
My next update to the code will add the possibility to automate the webscraping via ScrapeGraphAI, i will make a code in python called scrap, it will atutomate most of the process of webscraping, including sites search, and management of the data acquired. It will be slowly implemented, and will probably be done in about 2 to 3 weeks in maximum.
